...
React выбран как основной стек вакансии, а Next.js позволяет держать интерфейс и небольшой серверный маршрут для OpenRouter в одном проекте. Так ключ остаётся на сервере без отдельного бэкенда и его настройки при локальном запуске.
